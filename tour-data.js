...
//  admin.html から生成  2026/3/18 16:33:33
// ================================================================
// ※ このファイルはテキストエディタ（メモ帳、VS Code 等）で開いてください。
//   ダブルクリックで開こうとすると Windows Script Host がエラーを出す場合があります。
//   → 右クリック →「プログラムから開く」→「メモ帳」などを選択してください。
if (typeof window === 'undefined') {
  (function() {
    try { var W = WScript; if (W) { W.Quit(0); } } catch(e) {}
  })();
}
...
const TOUR_DATA = {
  ...
  "basic": {
    "tourTitle": "HondaGO TOUR in 伊豆箱根",
    "tourSubtitle": "富士を望み、名道を駆ける3日間",
    "customerName": "近藤 一聖",
    "participantCount": "1名様",
    ...
    "items": [
      {
        ...
        "title": "集合",
        "place": "JR京都駅 中央口",
        "desc": "添乗員・田中が「Moto Tours Japan」の旗を持ってお待ちしております。集合後、行程説明を行います。9:00 出発予定。",
      ...
      },
      {
        ...
        "title": "観光バス出発",
        "place": "京都駅発",
        "desc": "本日使用の観光バスに乗車。添乗員より行程の説明を行います。座席は自由席です。",
      ...
      },
      {
        ...
        "desc": "世界遺産「清水の舞台」から京都市街を一望。音羽の滝・参道のお土産めぐりもお楽しみください。（約90分）",
      ...
      },
      {
        ...
        "title": "祇園・産寧坂 散策",
        "place": "京都市東山区祇園町〜産寧坂",
        "desc": "石畳の風情ある路地を散策。昼食はこのエリアのお好みのお店でお楽しみください（費用各自）。（約120分）",
      ...
      },
      {
        ...
        "title": "金閣寺 鑑賞",
        "place": "京都市北区金閣寺町1",
        "desc": "鏡湖池に映る黄金色の三層楼を鑑賞。世界遺産指定の日本最高峰の美を間近で。（約60分）",
      ...
      },
      {
        ...
        "title": "嵐山 竹林・渡月橋",
        "place": "京都市右京区嵐山〜嵯峨野",
        "desc": "神秘的な竹林の小径と渡月橋を散策。嵐山のお土産めぐりも。（約90分）",
      ...
      },
      {
        ...
        "title": "ホテルチェックイン",
        "place": "京都グランドホテル",
        "desc": "チェックイン後の夕食・夜の散策は自由です。鴨川沿いや先斗町など夜の京都もお楽しみください。",
    ...
    "items": [
      {
        "time": "08:00〜09:15",
        "title": "朝食（ホテル内レストラン）",
        "place": "京都グランドホテル 1F レストラン",
        "desc": "和洋バイキング形式の朝食。京野菜のおばんざい・お粥・クロワッサンなど豊富なメニューをお楽しみください。",
      ...
      },
      {
        ...
        "title": "チェックアウト・ホテル出発",
        "place": "京都グランドホテル",
        "desc": "チェックアウト後、ホテル玄関前に集合。荷物は観光バスに積み込みます。チェックアウトは10:00が期限です。",
      ...
      },
      {
        ...
        "title": "観光バスにて大阪へ移動",
        "place": "京都→大阪",
        "desc": "阪神高速経由にて大阪市内へ移動（約60分）。バス内ではガイドより大阪の見どころをご案内します。",
        "icon": "fa-solid fa-bus",
        "badge": "",
        "badgeType": "",
        "isHighlight": false
      },
      {
        ...
        "title": "大阪城 見学",
        "place": "大阪市中央区大阪城1−1",
        "desc": "豊臣秀吉築城の国の特別史跡。天守閣最上階から大阪市内を360度一望。歴史展示も充実。（約90分）",
      ...
      },
      {
        ...
        "title": "道頓堀 昼食・散策",
        "place": "大阪市中央区道頓堀",
        "desc": "グループにて大阪名物グルメを堪能（昼食費含む）。グリコサイン前で記念撮影・戎橋周辺を散策。",
      ...
      },
      {
        ...
        "title": "なんば・心斎橋 自由散策",
        "place": "大阪市中央区〜浪速区",
        "desc": "大阪最大のショッピングエリアで自由行動。お土産・グルメをお楽しみください。（約105分）",
      ...
      },
      {
        ...
        "title": "ホテルチェックイン",
        "place": "大阪プレミアムホテル",
        "desc": "2泊目のホテルにチェックイン。夕食・夜の大阪散策は自由です。道頓堀や心斎橋など夜の大阪をお楽しみください。",
        "icon": "fa-solid fa-hotel",
        "badge": "宿泊",
        "badgeType": "green",
        "isHighlight": true
    ...
    "items": [
      {
        "time": "08:00〜09:00",
        "title": "朝食（ホテル内レストラン）",
        "place": "大阪プレミアムホテル 1F レストラン",
        "desc": "ゆったりとした朝食でエネルギーチャージ。和洋バイキング形式にてご提供します。",
        "icon": "fa-solid fa-mug-hot",
        "badge": "朝食込",
        "badgeType": "blue",
        "isHighlight": false
      ...
      },
      {
        ...
        "title": "観光バスにて奈良へ移動",
        "place": "大阪→奈良",
        "desc": "阪奈道路経由にて奈良市内へ移動（約60分）。バス内ではガイドより奈良の見どころをご案内します。",
        "icon": "fa-solid fa-bus",
        "badge": "",
        "badgeType": "",
        "isHighlight": false
      },
      {
        ...
        "title": "東大寺 大仏殿 見学",
        "place": "奈良市雑司町406-1",
        "desc": "世界最大級の木造建築・東大寺大仏殿で高さ14.7mの盧舎那仏（奈良の大仏）を拝観。圧倒的なスケールをご体感ください。（約75分）",
        "icon": "fa-solid fa-gopuram",
        "badge": "入場料込",
        "badgeType": "blue",
        "isHighlight": true
      ...
      {
        "time": "12:00〜14:00",
        "title": "奈良公園 鹿と触れ合い・散策",
        "place": "奈良市奈良公園周辺",
        "desc": "世界遺産・奈良公園で約1,200頭の野生の鹿と触れ合い。鹿せんべい（各自・100円）を購入して給餌体験も。",
      ...
      },
      {
        ...
        "title": "ならまち 昼食・散策",
        "place": "奈良市元興寺町周辺",
        "desc": "奈良の古い町並みが残る「ならまち」で昼食（費用込み）。奈良漬け・柿の葉寿司・三輪素麺など奈良グルメをお楽しみください。",
        "icon": "fa-solid fa-utensils",
        "badge": "昼食込",
        "badgeType": "blue",
        "isHighlight": false
      },
      {
        ...
        "title": "観光バスにて新大阪へ移動",
        "place": "奈良→新大阪",
        "desc": "奈良市内より新大阪駅へ移動（約80分）。車内でお土産タイムとアンケート記入をお願いいたします。",
        "icon": "fa-solid fa-bus",
        "badge": "",
        "badgeType": "",
        "isHighlight": false
      },
      {
        "time": "17:00",
        "title": "ツアー終了・解散",
        "place": "JR 新大阪駅 新幹線改札前",
        "desc": "添乗員によるご挨拶の後、解散となります。お気をつけてお帰りください。またのご利用を心よりお待ちしております。",
  ...
  "highlights": [
    {
      "title": "清水の舞台からの絶景",
      "desc": "世界遺産・清水寺の舞台から京都市街を一望。春は桜も楽しめます。",
      "icon": "fa-solid fa-torii-gate",
      "color": "#2D6A4F"
    },
    {
      "title": "金閣寺の黄金の輝き",
      "desc": "鏡湖池に映る黄金の金閣は、室町文化の粋を今に伝えます。",
      "icon": "fa-solid fa-gopuram",
      "color": "#AA0000"
    },
    {
      "title": "嵐山の竹林を歩く",
      "desc": "空へ伸びる無数の竹が織りなす神秘的な空間を散策。",
      "icon": "fa-solid fa-tree",
      "color": "#1A4D2E"
    },
    {
      "title": "大阪城からの眺め",
      "desc": "天守閣から360度の大阪市内の絶景。歴史展示も充実。",
      "icon": "fa-solid fa-chess-rook",
      "color": "#6B1A1A"
    },
    {
      "title": "道頓堀で食い倒れ",
      "desc": "たこ焼き・串カツ・お好み焼き——大阪名物グルメを堪能！",
      "icon": "fa-solid fa-utensils",
      "color": "#8B3A00"
    },
    {
      "title": "奈良の大仏と鹿に出会う",
      "desc": "世界最大級の木造建築・東大寺大仏殿で大仏を拝観し、野生の鹿と触れ合う。",
      "icon": "fa-solid fa-paw",
      "color": "#3A5A2A"
    },
    {
      "title": "祇園でショッピング",
      "desc": "石畳の祇園・産寧坂で京みやげ探し。",
      "icon": "fa-solid fa-shopping-bag",
      "color": "#3A1A6B"
    }
  ],
  ...
  "tips": [
    {
      ...
      "iconColor": "#CC0000",
      "content": "4月の京都・大阪は日中20〜22℃前後。朝晩は10℃前後まで冷え込む場合があります。薄手のジャケットなどレイヤースタイルがおすすめ。桜の季節と重なることが多いため折りたたみ傘もご用意ください。"
    },
    {
      "title": "移動・交通",
      "icon": "fa-solid fa-train",
      "iconColor": "#CC0000",
      "content": "ツアー中の移動は観光バスを利用します。バスは時間通りに出発しますので余裕を持って集合場所へお集まりください。自由行動中はICカード（ICOCA・Suicaなど）が便利です。"
    },
    {
      "title": "食事・グルメ",
      "icon": "fa-solid fa-bowl-rice",
      "iconColor": "#CC0000",
      "content": "京都おすすめ：湯豆腐・おばんざい・抹茶スイーツ。大阪おすすめ：たこ焼き・串カツ・551の豚まん。飲食店によっては現金のみの場合があります。食物アレルギーのある方は事前に添乗員にお知らせください。"
    },
    {
      "title": "マナー・エチケット",
      "icon": "fa-solid fa-hand-peace",
      "iconColor": "#CC0000",
      "content": "神社・寺院での撮影禁止エリアに注意しましょう。歩きタバコ・路上喫煙は条例で禁止。電車内での大声での会話はご遠慮ください。自撮り棒の使用が制限されているエリアがあります。"
    },
    {
      "title": "両替・お支払い",
      "icon": "fa-solid fa-yen-sign",
      "iconColor": "#CC0000",
      "content": "日本では現金払いが主流です。両替は京都駅・新大阪駅・コンビニATMが便利。1人あたり1〜2万円の現金をご用意ください。主要クレジットカード・PayPay・交通系ICも多くの店舗で利用可能です。"
    },
    {
      "title": "Wi-Fi・通信",
      "icon": "fa-solid fa-wifi",
      "iconColor": "#CC0000",
      "content": "主要観光地・駅・コンビニでフリーWi-Fi利用可能。ホテルは全館無料Wi-Fi完備です。海外からお越しの方は日本のSIMカードやポケットWi-Fiのレンタルをお勧めします（空港にて手配可能）。"
    }
  ],
  "emergency": {
  ...
  "goods": [
    {
      ...
      "icon": "fa-solid fa-mug-hot",
      "iconBg": "#CC0000",
      "desc": "たびびとロゴの磁器製マグカップ。電子レンジ・食洗機対応。",
      "badge": "在庫あり",
      "badgeType": "green"
    },
    {
      ...
      "iconBg": "#CC0000",
      "desc": "旅人イラストプリント。S/M/L/XL、白・ネイビーの2色展開。",
      "badge": "在庫あり",
      "badgeType": "green"
    },
    {
      ...
      "iconBg": "#CC0000",
      "desc": "コンパクトに折りたためるエコバッグ。お土産入れにも普段使いにも。",
      "badge": "在庫あり",
      "badgeType": "green"
    },
    {
      ...
      "iconBg": "#CC0000",
      "desc": "地図・旅程メモ欄付きA6ノート。旅の思い出を書き留めて。",
      "badge": "在庫あり",
      "badgeType": "green"
    },
    {
    ...
    },
    {
      ...
      "iconBg": "#CC0000",
      "desc": "絶景写真を使ったオリジナル5枚セット。旅先から大切な人へ。",
      "badge": "在庫あり",
      "badgeType": "green"
    }
  ],
  "sns": [
    ...
    {
      "platform": "YouTube",
      "handle": "Moto Tours Japan 公式",
      "desc": "ツアー動画・旅のVlog公開中",
  ...
  "survey": {
    "url": "https://forms.google.com/your-form-url-here",
    "title": "ご旅行満足度アンケート",
